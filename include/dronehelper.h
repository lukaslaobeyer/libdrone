...
bool drone_flattrim(std::shared_ptr<Drone> drone);
bool drone_calibmagneto(std::shared_ptr<ARDrone2> drone);
...
bool drone_setCameraOrientation(std::shared_ptr<Bebop> drone, float tilt, float pan);
